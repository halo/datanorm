...
class PricesetTest < Minitest::Test
  def test_set
    line = 'P;A;QLI100DALIRO;1;43630;1;3100;;;;;Q150150NWRO;1;38770;1;3100;;;;;Q150153NWRO;1;48290;1;3100;;;;;'

    record = Datanorm::Lines::V4::Priceset.new(columns: line.split(';'), source_line_number: 1)

    assert_equal 'P', record.record_kind
    assert_raises(RuntimeError, 'A Priceset with multiple products does not have one single ID') { record.id }
